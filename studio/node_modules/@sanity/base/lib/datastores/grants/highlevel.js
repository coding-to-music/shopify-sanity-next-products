...
function canUpdate(id, typeName) {
  ...
  return (0, _snapshotPair.snapshotPair)(idPair, typeName).pipe((0, _operators.mergeMap)(pair => (0, _rxjs.combineLatest)([pair.draft.snapshots$, pair.published.snapshots$])), (0, _operators.switchMap)(_ref => {
...
function canDelete(id, typeName) {
  var type = getSchemaType(typeName);
  var idPair = getIdPairFromPublished(id);
  return (0, _snapshotPair.snapshotPair)(idPair, typeName).pipe((0, _operators.mergeMap)(pair => (0, _rxjs.combineLatest)([pair.draft.snapshots$, pair.published.snapshots$])), (0, _operators.map)(_ref3 => {
...
function canPublish(id, typeName) {
  var idPair = getIdPairFromPublished(id);
  return (0, _snapshotPair.snapshotPair)(idPair, typeName).pipe((0, _operators.mergeMap)(pair => (0, _rxjs.combineLatest)([pair.draft.snapshots$, pair.published.snapshots$])), (0, _operators.map)(_ref7 => {
...
function canUnpublish(id, typeName) {
  var idPair = getIdPairFromPublished(id);
  return (0, _snapshotPair.snapshotPair)(idPair, typeName).pipe((0, _operators.mergeMap)(pair => (0, _rxjs.combineLatest)([pair.draft.snapshots$, pair.published.snapshots$])), (0, _operators.map)(_ref11 => {
...
function canDiscardDraft(id, typeName) {
  var idPair = getIdPairFromPublished(id);
  return (0, _snapshotPair.snapshotPair)(idPair, typeName).pipe((0, _operators.mergeMap)(pair => pair.draft.snapshots$), (0, _operators.map)(draft => draft || stub(idPair.draftId, typeName)), (0, _operators.switchMap)(draft => _.default.checkDocumentPermission('update', draft)));
}
