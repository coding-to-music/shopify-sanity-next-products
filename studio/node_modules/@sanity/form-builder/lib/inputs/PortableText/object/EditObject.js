...
var EditObject = _ref => {
  ...
  var editModalLayout = (0, _get2.default)(type, 'options.editModal'); // Initialize weakmaps on mount, and send patches on unmount
  ...
  if (editModalLayout === 'popover' || editModalLayout === 'fold' || kind === 'annotation' && typeof editModalLayout === 'undefined') {
