...
function BlockObject(props) {
  ...
  var hasMarkers = blockMarkers.length > 0;
  ...
  var tooltipEnabled = hasErrors || hasWarnings || Boolean(hasMarkers && renderCustomMarkers);
